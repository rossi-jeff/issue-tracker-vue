...
<div class="new-user">
  ...
  <b-card border-variant="dark" header-bg-variant="light" header="New User" class="m-2">
    <b-card-text>
      <FormUser :key="formKey" :user="user" :showPass="true" :enabled="true" @editEmail="editEmail" @deleteEmail="deleteEmail" @editPhone="editPhone" @deletePhone="deletePhone" @addEmail="addEmail" @addPhone="addPhone" />
