      ...
      <b-collapse id="issue-filters" class="mx-2 my-4">
        <b-row cols="1" cols-sm="2" cols-md="4" cols-lg="9" cols-xl="9">
          <b-col>
            ...
            <b-form-select v-model="Priority" :options="PriorityArray" @change="updateFilters" style="width: 90%" class="p-1 my-1"></b-form-select>
          </b-col>
          <b-col>
            <div>
              <strong>Status</strong>
            </div>
            <b-form-select v-model="Status" :options="StatusArray" @change="updateFilters" style="width: 90%" class="p-1 my-1"></b-form-select>
          </b-col>
          <b-col>
            <div>
              <strong>Type</strong>
            </div>
            <b-form-select v-model="Type" :options="IssueTypeArray" @change="updateFilters" style="width: 90%" class="p-1 my-1"></b-form-select>
          </b-col>
          <b-col>
            <div>
              <strong>Complexity</strong>
            </div>
            <b-form-select v-model="Complexity" :options="ComplexityArray" @change="updateFilters" style="width: 90%" class="p-1 my-1"></b-form-select>
          </b-col>
          <b-col>
            <div>
              <strong>Author</strong>
            </div>
            <b-form-select v-model="AuthorId" :options="authors" @change="updateFilters" style="width: 90%" class="p-1 my-1"></b-form-select>
          </b-col>
          <b-col>
            <div>
              <strong>Assigned</strong>
            </div>
            <b-form-select v-model="AssignedToId" :options="assigned" @change="updateFilters" style="width: 90%" class="p-1 my-1"></b-form-select>
          </b-col>
          <b-col class="py-2">
