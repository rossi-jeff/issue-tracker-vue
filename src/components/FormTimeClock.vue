...
<script>
export default {
  props: ["timeclock", "options", "session"],
  methods: {
    projectChanged() {
      this.$emit("projectChanged");
    },
    issueChanged() {
      this.$emit("issueChanged");
    }
  }
};
</script>
