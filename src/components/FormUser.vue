    ...
    <div class="accordion" role="tablist">
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-2" role="tab">
          <b-button
            v-b-toggle.credentials-panel
            style="width: 100%"
            variant="primary"
            >Credentials</b-button
          >
        </b-card-header>
        <b-collapse
        ...
        >
          ...
          >
            <b-col class="p-2">
              ...
              <div class="vee-validate-error p-2">
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-2" role="tab">
          <b-button style="width: 100%" variant="primary" v-b-toggle.name-panel
            >Name</b-button
          >
        </b-card-header>
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-2" role="tab">
          <b-button style="width: 100%" variant="primary" v-b-toggle.email-panel
            >Email</b-button
          >
        </b-card-header>
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-2" role="tab">
          <b-button style="width: 100%" variant="primary" v-b-toggle.phone-panel
            >Phone</b-button
          >
        </b-card-header>
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-2" role="tab">
          <b-button style="width: 100%" variant="primary" v-b-toggle.role-panel
            >Role</b-button
          >
        </b-card-header>
...
<script>
import { UsageArray, PhoneTypeArray, RoleArray } from "../lib/options";
